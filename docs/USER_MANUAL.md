...
- **Mobile Compatible**: Runs on modern smartphones! Works in Chrome for Android or Safari (iOS 17+) and can be installed to your home screen. Note: computing AI locally consumes noticeable battery power.
